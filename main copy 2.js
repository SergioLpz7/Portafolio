...
function MostrarTema(numeroTema) {
  const proyectLi = document.querySelectorAll(".lista-proyectos li");
  for (let i = 0; i < proyectLi.length; i++) {
    proyectLi[i].classList.remove("active");
  }
  ...
  proyectLi[numeroTema - 1].classList.add("active");
}
